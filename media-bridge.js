(() => {
  const apply = () => {
    ...
    if (hero && !document.querySelector('.isang-about-home')) {
      ...
      about.innerHTML = `<div class="isang-about-home-inner"><div class="isang-about-visual"><div class="isang-about-slides"><img class="active" src="/assets/ai-cleanroom-about.jpg" alt="클린룸 작업 환경"><img src="/assets/ai-business-engineering.jpg" alt="클린룸 엔지니어링"><img src="/assets/ai-project-installation.jpg" alt="클린룸 시공 현장"></div><button class="isang-about-prev" aria-label="이전 이미지">←</button><button class="isang-about-next" aria-label="다음 이미지">→</button><div class="isang-about-dots"><i class="active"></i><i></i><i></i></div></div><div class="isang-about-copy"><span class="isang-about-eyebrow">ABOUT US</span><div class="isang-about-title-row"><h2>클린환경을 설계하는<br>엔지니어링 파트너,<br><em>이상이엔지</em></h2><span class="isang-about-side-note">클린룸 전문<br>설계, 시공, 보수 전문<br>이상이엔지</span></div><p>이상이엔지는 반도체, 바이오, 배터리, 데이터센터 등 첨단 산업의 공정에 필요한 클린환경을 설계하고 구축하는 전문 엔지니어링 기업입니다.</p><p>단순한 시공이 아닌 공정의 특성과 요구조건을 분석해 최적의 환경을 설계하고, 공조·제어·클린룸 기술을 융합한 통합 솔루션을 제공합니다.</p><a class="isang-about-more" href="/about">회사소개 더보기 <span>→</span></a><div class="isang-about-features"><div><strong>⊙</strong><b>Precision</b><p>정밀한 환경 설계<br>공정의 요구조건을 정확히 분석합니다.</p></div><div><strong>♧</strong><b>Engineering</b><p>전문 엔지니어링 역량<br>풍부한 경험과 기술력으로 제안합니다.</p></div><div><strong>⌘</strong><b>Integration</b><p>통합 솔루션<br>공조·제어·클린룸을 하나로 연결합니다.</p></div><div><strong>♢</strong><b>Reliability</b><p>지속 가능한 가치<br>안정적인 운영을 위한 파트너가 됩니다.</p></div></div></div></div>`;
      const style = document.createElement('style');
      style.textContent = `.isang-about-home{background:#f8f9fa;border-top:1px solid #e2e6ea;border-bottom:1px solid #e2e6ea;color:#1c2b3b;margin-top:52px;padding:76px 6vw}.isang-about-home-inner{max-width:1240px;margin:0 auto;display:grid;grid-template-columns:minmax(520px,1.05fr) minmax(0,1.25fr);gap:62px;align-items:center}.isang-about-visual{position:relative;height:520px;overflow:hidden;background:#dce3e9;border:4px solid #17202a;padding:20px}.isang-about-slides{position:relative;width:100%;height:100%;overflow:hidden}.isang-about-slides img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0;transition:opacity .55s ease;filter:saturate(.55) contrast(1.02)}.isang-about-slides img.active{opacity:.86}.isang-about-prev,.isang-about-next{position:absolute;top:50%;transform:translateY(-50%);width:34px;height:34px;border:1px solid rgba(255,255,255,.7);border-radius:50%;background:rgba(14,35,52,.28);color:#fff;font-size:18px;line-height:1;cursor:pointer;z-index:2}.isang-about-prev{left:8px}.isang-about-next{right:8px}.isang-about-dots{position:absolute;bottom:10px;left:50%;transform:translateX(-50%);display:flex;gap:6px;z-index:2}.isang-about-dots i{display:block;width:5px;height:5px;border-radius:50%;background:rgba(255,255,255,.55)}.isang-about-dots i.active{background:#fff}.isang-about-title-row{display:flex;align-items:flex-start;justify-content:space-between;gap:28px}.isang-about-side-note{font-size:12px;line-height:1.8;color:#465666;white-space:nowrap;margin-top:24px}.isang-about-title-row h2{flex:1}.isang-about-visual>img{width:100%;height:100%;display:block;object-fit:cover;filter:saturate(.55) contrast(1.02);opacity:.86}.isang-about-wash{position:absolute;inset:0;background:linear-gradient(135deg,rgba(20,49,75,.34),rgba(58,128,185,.08));pointer-events:none}.isang-about-copy{padding:8px 0;position:relative}.isang-about-eyebrow{display:block;color:#1772b9;font:600 11px 'DM Mono',monospace;letter-spacing:.16em;margin-bottom:24px}.isang-about-eyebrow:before{content:'';display:inline-block;width:20px;height:1px;background:#1772b9;vertical-align:middle;margin-right:10px}.isang-about-copy h2{font-size:clamp(27px,3vw,39px);line-height:1.3;letter-spacing:-.075em;margin:0 0 25px;color:#182b3e}.isang-about-copy h2 em{color:#1675bd;font-style:normal}.isang-about-copy>p{font-size:13px;line-height:1.9;color:#687887;letter-spacing:-.035em;margin:0 0 14px;max-width:620px}.isang-about-more{display:inline-flex;align-items:center;gap:14px;border-bottom:1px solid #23394d;color:#23394d;text-decoration:none;font-size:12px;font-weight:600;padding:0 0 9px;margin-top:8px}.isang-about-more span{font-size:17px}.isang-about-features{display:grid;grid-template-columns:repeat(4,1fr);gap:22px;margin-top:54px;padding-top:25px;border-top:1px solid #dce2e7}.isang-about-features div{display:flex;flex-direction:column;min-width:0}.isang-about-features strong{color:#1873b8;font-size:20px;font-weight:400;line-height:1;margin-bottom:15px}.isang-about-features b{font-size:14px;font-weight:600;margin-bottom:9px;color:#22384c}.isang-about-features p{font-size:12px;line-height:1.7;color:#7b8995;margin:0}@media(min-width:1920px){.isang-about-home-inner{max-width:1500px}.isang-about-visual{height:570px}.isang-about-home{padding-left:5vw;padding-right:5vw}}@media(max-width:900px){.isang-about-home{margin-top:40px;padding:58px 20px}.isang-about-home-inner{grid-template-columns:1fr;max-width:680px;gap:38px}.isang-about-visual{height:360px;padding:12px;border-width:3px}.isang-about-copy{padding:0}.isang-about-title-row{display:block}.isang-about-side-note{display:none}.isang-about-copy h2{font-size:30px}.isang-about-features{margin-top:38px;gap:14px}}@media(max-width:560px){.isang-about-copy h2{font-size:25px}.isang-about-features{grid-template-columns:1fr 1fr;row-gap:24px}.isang-about-features p{font-size:13px}}`;
      document.head.appendChild(style);
      hero.parentNode.insertBefore(about, hero.nextSibling);
    }
    const homeAbout = document.querySelector('.isang-about-home');
    if (homeAbout && !homeAbout.dataset.sliderReady) {
      homeAbout.dataset.sliderReady = 'true';
      const slides = Array.from(homeAbout.querySelectorAll('.isang-about-slides img'));
      const dots = Array.from(homeAbout.querySelectorAll('.isang-about-dots i'));
      let current = 0;
      const showSlide = (index) => { current = (index + slides.length) % slides.length; slides.forEach((img, i) => img.classList.toggle('active', i === current)); dots.forEach((dot, i) => dot.classList.toggle('active', i === current)); };
      homeAbout.querySelector('.isang-about-prev')?.addEventListener('click', () => showSlide(current - 1));
      homeAbout.querySelector('.isang-about-next')?.addEventListener('click', () => showSlide(current + 1));
