(() => {
  const apply = () => {
    ...
    if (footer && !document.querySelector('.isang-clients')) {
      const clients = document.createElement('section');
      clients.className = 'isang-clients';
      clients.setAttribute('aria-label', 'Our Clients');
      clients.innerHTML = `<div class="isang-clients-inner"><div class="isang-clients-top"><h2>OUR CLIENTS</h2><div class="isang-clients-arrows"><button type="button" class="isang-client-prev" aria-label="이전 고객사">‹</button><button type="button" class="isang-client-next" aria-label="다음 고객사">›</button></div></div><div class="isang-client-rail"><div class="isang-client-logo isang-client-symbol"><strong>TS</strong><small>ENGINEERING</small></div><div class="isang-client-logo"><strong>KIRIN</strong></div><div class="isang-client-logo"><strong class="avogen">◒AVogen</strong></div><div class="isang-client-logo"><strong class="shinsung">❝</strong><small>Shinsung<br>Engineering</small></div><div class="isang-client-logo"><strong class="kumyoung">K</strong><small>KUM YOUNG<br>ENG</small></div><div class="isang-client-logo"><strong class="jungang">중앙백신</strong><small>연구소</small></div></div></div>`;
      const style = document.createElement('style');
      style.textContent = `.isang-clients{background-color:#fff;background-image:radial-gradient(rgba(25,53,82,.12) .7px,transparent .7px);background-size:8px 8px;border-top:1px solid #edf0f3;border-bottom:1px solid #edf0f3;padding:72px 6vw 78px;color:#203a55}.isang-clients-inner{max-width:1240px;margin:0 auto}.isang-clients-top{display:flex;align-items:center;justify-content:space-between;margin-bottom:38px}.isang-clients-top h2{margin:0;font-size:30px;letter-spacing:.02em;font-weight:800}.isang-clients-arrows{display:flex;gap:20px}.isang-clients-arrows button{border:0;background:transparent;color:#9aa3ab;font:300 40px/1 Arial;cursor:pointer;padding:0 5px;transition:.2s}.isang-clients-arrows button:hover{color:#203a55;transform:scale(1.08)}.isang-client-rail{display:flex;align-items:center;justify-content:space-between;gap:32px;overflow:hidden}.isang-client-logo{flex:0 0 auto;min-width:130px;height:76px;display:flex;align-items:center;justify-content:center;flex-direction:column;color:#c7c9cb;text-align:center;filter:grayscale(1);opacity:.92}.isang-client-logo strong{font-size:26px;letter-spacing:-.04em;font-weight:800}.isang-client-logo small{font-size:10px;line-height:1.2;letter-spacing:.08em}.isang-client-symbol strong{border:3px solid #c7c9cb;padding:4px 7px;font-size:19px;line-height:1}.isang-client-symbol small{margin-top:5px}.isang-client-logo .avogen{font-size:20px;font-weight:700}.isang-client-logo .shinsung{font-size:38px;line-height:24px}.isang-client-logo .kumyoung{background:#c7c9cb;color:white;width:54px;height:54px;display:grid;place-items:center;font-size:33px;margin-bottom:4px}.isang-client-logo .jungang{font-size:19px;letter-spacing:-.12em}@media(max-width:800px){.isang-clients{padding:52px 20px 56px}.isang-clients-top{margin-bottom:24px}.isang-clients-top h2{font-size:24px}.isang-client-rail{justify-content:flex-start;gap:24px;overflow-x:auto;scroll-behavior:smooth;padding-bottom:6px;scrollbar-width:none}.isang-client-rail::-webkit-scrollbar{display:none}.isang-client-logo{min-width:112px;height:66px}.isang-client-logo strong{font-size:21px}.isang-client-logo .shinsung{font-size:32px}}`;
      document.head.appendChild(style);
      footer.parentNode.insertBefore(clients, footer);
      const rail = clients.querySelector('.isang-client-rail');
      clients.querySelector('.isang-client-prev').onclick = () => rail.scrollBy({left:-260, behavior:'smooth'});
      clients.querySelector('.isang-client-next').onclick = () => rail.scrollBy({left:260, behavior:'smooth'});
    }
