  ...
  const apply = () => {
    ...
    if (hero) {
      ...
      if (!hero.querySelector('.hero-business-buttons')) {
        ...
        style.textContent = `.hero-business-buttons{position:absolute;z-index:3;right:5vw;top:55%;transform:translateY(-50%);display:grid;grid-template-columns:repeat(4,minmax(92px,1fr));gap:4px;width:min(45vw,560px)}.hero-business-buttons a{min-height:154px;padding:18px 10px 13px;border:1px solid rgba(255,255,255,.22);border-radius:5px;background:rgba(16,45,68,.22);backdrop-filter:blur(8px);color:#fff;text-decoration:none;display:flex;flex-direction:column;align-items:center;justify-content:center;transition:background .25s,transform .25s,border-color .25s}.hero-business-buttons a:hover{background:rgba(34,126,194,.42);transform:translateY(-4px);border-color:rgba(255,255,255,.65)}.hero-business-icon{font-size:23px;line-height:1;margin-bottom:18px;color:rgba(255,255,255,.88);font-weight:300}.hero-business-buttons b{font-size:11px;letter-spacing:.02em;font-weight:600}.hero-business-buttons small{font-size:8px;margin-top:7px;color:rgba(255,255,255,.72);text-align:center;line-height:1.35}.hero-business-buttons em{font-style:normal;font-size:15px;margin-top:12px;color:rgba(255,255,255,.85)}@media(max-width:1050px){.hero-business-buttons{right:3vw;width:48vw;gap:3px}.hero-business-buttons a{min-height:135px;padding:15px 6px 11px}.hero-business-icon{font-size:20px;margin-bottom:13px}.hero-business-buttons small{font-size:7px}}@media(max-width:720px){.hero-business-buttons{top:auto;bottom:25px;left:18px;right:18px;transform:none;width:auto;grid-template-columns:repeat(2,1fr);gap:5px}.hero-business-buttons a{min-height:102px;padding:11px 7px}.hero-business-icon{font-size:19px;margin-bottom:8px}.hero-business-buttons b{font-size:11px}.hero-business-buttons small{font-size:8px;margin-top:4px}.hero-business-buttons em{font-size:13px;margin-top:5px}}`;
      ...
      if (buttons) {
        ...
        if (window.innerWidth <= 720) {
          ...
          buttons.style.setProperty('top', '55%', 'important');
          ...
          buttons.style.setProperty('width', 'min(45vw, 560px)', 'important');
